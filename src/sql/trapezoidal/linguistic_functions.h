...
text *seconds_to_str(trapezoidal_function *func) {
    ...
    return to_text(trapezoidal_function_to_string(func));
}

PG_FUNCTION_INFO_V1(pg_seconds_to_str);
Datum pg_seconds_to_str(PG_FUNCTION_ARGS) {
    trapezoidal_function *func = (trapezoidal_function*) PG_GETARG_POINTER(0);
    text* result = seconds_to_str(func);
...
PG_FUNCTION_INFO_V1(pg_days_to_str);
Datum pg_days_to_str(PG_FUNCTION_ARGS) {
    trapezoidal_function *func = (trapezoidal_function*) PG_GETARG_POINTER(0);
    text* result = days_to_str(func);
    PG_RETURN_TEXT_P(result);
}
